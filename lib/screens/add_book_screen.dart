...
class _AddBookScreenState extends State<AddBookScreen> {
  ...
  final selectCategory = ["Action and Adventure",
  "Classics",
  ...
  TextEditingController bAddingDateController = TextEditingController();
        ...
        child: Column(
          ...
          children: [
            Padding(
                ...
                child: const Text("Add Book",style:
                  TextStyle(
                    fontSize: 20
                  ),)),
            _buildBName(),
        ...
        Container(
          child: TextFormField(
            onTap: () async{
              ...
              setState(() => datePick= "${newDate.year.toString()}-${newDate.month.toString()}-${newDate.day.toString()}");
              print(newDate);
            },
            readOnly: true,
  ...
  DropdownMenuItem<String> buildMenuUnit(String cate)=>
      DropdownMenuItem(
        value: cate,
        child: Text(cate,
          style: TextStyle(
